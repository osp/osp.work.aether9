...
% Patch
\definesimplefont[kapatch][karlapatch][size=12pt] 
\definesimplefont[crimpatch][crimsontextpatch][size=9pt] 
...
% Chat
\definesimplefont[kachat][karlachat][size=12pt] 
\definesimplefont[crimchat][crimsontextchat][size=9pt] 
...
% Cash
\definesimplefont[kacash][karlacash][size=12pt] 
\definesimplefont[crimcash][crimsontextcash][size=9pt] 
...
% Red
\definesimplefont[kared][karlared][size=12pt] 
\definesimplefont[crimred][crimsontextred][size=9pt] 
...
% Science
\definesimplefont[kascience][karlascience][size=12pt] 
...
% Themes
\definesimplefont[kathemes][karlathemes][size=12pt] 
...
% Network == Tech
\definesimplefont[kanetwork][karlanetwork][size=12pt] 
\definesimplefont[crimnetwork][crimsontextnetwork][size=9pt] 
...
\definesimplefont[katech][karlanetwork][size=12pt] 
\definesimplefont[crimtech][crimsontextnetwork][size=9pt] 
