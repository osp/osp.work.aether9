...
% LAYOUT {{{
    ...
    \definecolumnset[duo][n=2, distance=12mm, width=\getvariables[pageprops][columnwidth]]
...
%     \definepagebreak[emptyeven][yes,header,footer, even]
    ...
    \setupfootertexts [section][pagenumber]
...
%             before=\nowhitespace,
%             after=\nowhitespace,
%             style={\tfd \setupbodyfont[karlaregular]},
%             ]
...
%             page=yes,
            after=\nowhitespace,
            style={\tfd \cap \setupbodyfont[karlaregular, 27pt]},
            ]
...
% PARAGRAPHS {{{
    ...
    \setupparagraphs[mail][1][
        style={\setupbodyfont[crimsontexto, 8pt]},
        after=\nowhitespace,
        ] 
