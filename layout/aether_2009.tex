...
% 1. Two screens (one for \stylerefmailchat{Skype}\stylerefroadrwdonly{543} \stylerefmailchat{chat} \stylerefroadfwdonly{562} and \stylerefmailpatch{Patch}\stylerefroad{543}{581} the other for MAIN AETHER WINDOW)
...
1. Two screens (one for \stylerefmailchat{Skype} \stylerefmailchat{chat} and \stylerefmailpatch{Patch} the other for MAIN AETHER WINDOW)
...
\infopar Residency @ _____-micro research
